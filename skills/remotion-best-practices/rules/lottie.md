...
```bash
npm i @remotion/lottie # If project uses npm
bun i @remotion/lottie # If project uses bun
yarn add @remotion/lottie # If project uses yarn
pnpm i @remotion/lottie # If project uses pnpm
```
