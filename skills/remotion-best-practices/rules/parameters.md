...
```bash
npm i @remotion/zod-types # If project uses npm
bun i @remotion/zod-types # If project uses bun
yarn add @remotion/zod-types # If project uses yarn
pnpm i @remotion/zod-types # If project uses pnpm
```
