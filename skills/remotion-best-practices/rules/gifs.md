...
```bash
npm i @remotion/gif # If project uses npm
bun i @remotion/gif # If project uses bun
yarn add @remotion/gif # If project uses yarn
pnpm i @remotion/gif # If project uses pnpm
```
