...
```bash
npm i @remotion/layout-utils # If project uses npm
bun i @remotion/layout-utils # If project uses bun
yarn add @remotion/layout-utils # If project uses yarn
pnpm i @remotion/layout-utils # If project uses pnpm
```
