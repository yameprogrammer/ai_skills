...
echo "5) All Individual Skills Combined (312 skills)"
...
case "$choice" in
    ...
    3)
        ...
        for dir in skills/*/; do
            ...
            # 제외할 리스트 필터링
            if [ "$dir_name" == "clipify" ] || [ "$dir_name" == "video-use" ] || [ "$dir_name" == "youtube-clipper" ] || [ "$dir_name" == "remotion-best-practices" ] || [ "$dir_name" == "video-copywriting" ] || [ "$dir_name" == "video-ui-ux-design" ] || [ "$dir_name" == "video-producer" ] || [ "$dir_name" == "promo-video" ] || [[ "$dir_name" =~ ^godot- ]]; then
                continue
            fi
            in_anthropic=0
